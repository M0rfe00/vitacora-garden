...
> <a href="${tweetURL}" role="presentation" aria-hidden="true"><img src="${imgPath}" alt="Tweet" style="border-radius: 12px; margin: 0; padding: 0; display: block; max-width: 100%;"></a>`
%>
