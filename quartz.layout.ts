...
export const defaultContentPageLayout: PageLayout = {
  ...
  left: [
    ...
    Component.Explorer({
      ...
      useSavedState: true,
      filterFn: (node) => {
        const carpetasOcultas = ['Carpeta', 'Recursos-SMR(fd)', 'carpeta','Cine-Ver','(Lore Project)','LORE', 'FASHION PROJECTS', 'DESIGN PROJECTS', '3D PROJECTS', '(Portfolio Development)', 'ROMANIAN']
        if (node.isFolder) {
