      ...
      return [
        () => {
          return (tree: Root, _file) => {
            // NO modificamos el árbol, dejamos las imágenes tal cual
          }
        },
      ]
    },
        ...
        js: [
          {
            ...
            script: `
              ...
              function initLightbox() {
                ...
                const galleryImages = document.querySelectorAll('.galeria img, .galeria2 img, .galeria4 img, .galeria3D img');
