...
La marca no empieza en un programa de diseño sino con preguntas,:
- ¿Quién soy?
- ¿Qué hago?
- ¿Qué ofrezco?
- ¿Qué hago distinto?
...
No significa necesariamente crear contenido, mostrarse en redes y actuar frente a la cámara, consiste en amplificar lo que se es, mostrar lo que se hace con una intención y estrategia de forma constante, consistente, coherente comunicando el trabajo propio creando relaciones.



# Logos
___
Un logo ha de tener un propósito, no es únicamente un dibujo atractivo, es una síntesis visual, tiene que poder transmitir el espíritu de la marca con la menor cantidad de elementos posibles.
...
**Imagotipo:** Texto + Icono (Separados)

**Isomagotipo:** Texto +Icono (Integrados)
...
Por ello el logo ha de construirse inicialmente en formato vectorial aunque posteriormente se le realicen modificaciones para casos concretos.

Si el logo depende de un detalle para funcionar como un color concreto, transparencias, efecto, textura, no sirve.

El concepto de "Logo responsive" es cuanto puede agrandarse y reducirse el logo sin perder la esencia (solo un icono, las iniciales, etc) 
