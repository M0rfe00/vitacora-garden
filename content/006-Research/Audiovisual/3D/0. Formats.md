...
2) Seleccionar el personaje, File>Export como **Obj** 
...
1) Paña añadir la animación al personaje importado: añadir el modificador "MeshCache" y en file path seleccionar el archivo de animación "mdd" exportado antes
