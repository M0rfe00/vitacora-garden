...
___
Importar a Photoshop una imagen, por ejemplo manchas de pintura para crear un pincel de pecas.

Modificar la imagen para obtener el resultado deseado (borrar partes, duplicar, rotar...)

Desaturar la imagen y ajustar con curvas para generar mayor contraste

Invertir la imagen para que el fondo sea negro y la pintura blanca, Exportar como png

En Blender Texture Properties>Image>Settings>Open: Seleccionar el archivo png.
