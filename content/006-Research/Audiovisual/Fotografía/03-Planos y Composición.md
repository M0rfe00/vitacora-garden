...
___
**Existen otras muchas más reglas de composición además de los tres tercios que permiten muchas más posibilidades; algunas son; triángulos dorados, Líneas diagonales.**
<img
...
# **Jerarquía visual:**
___
**Algunas formas de establecer la jerarquía de importancia una composición:**

- Distribuir los elementos según su tamaño creando un orden de importancia en ellos.

- Utilizar el color para distribuir la atención de los elementos, suelen resaltar los cálidos, para ello se puede jugar con (Tono, saturación, luz) (balanceados y discordantes).
