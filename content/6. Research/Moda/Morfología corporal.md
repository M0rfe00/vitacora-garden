...
- La cintura es el punto focal; hombros y caderas se muestran armónicamente.
...
- Crear puntos de enfoque que sugieran curva; dividir verticalmente el cuerpo para dinamismo.

**Decisiones estéticas superiores:**
- Tops/Prendas con drapeados o capas y corte peplum.
...
- Desviar la atención de la zona media; equilibrar arriba y abajo con volumen estratégico.
...
>[!Info] GEOMETRIA - APLICACIÓN EN MODA 
>Cada silueta tiene una estructura geométrica básica que guía la percepción visual.
>
>La ropa puede reforzar, equilibrar o modificar estas líneas. Por ejemplo, un cinturón crea una cintura donde antes había rectitud; un escote en V suaviza hombros anchos.

>[!Info] EXPRESIÓN Y CARACTER - APLICACIÓN EN MODA
>El cuerpo comunica sensaciones y carácter de manera similar a un rostro.
>
