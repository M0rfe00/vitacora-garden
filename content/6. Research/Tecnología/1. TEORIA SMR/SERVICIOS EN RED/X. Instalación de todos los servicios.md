...
![[Instalación Servicios 20250709010113.png]]
...
![[Instalación Servicios 20250709010134.png]]

Para instalar el servicio FTP debemos y a los roles del servicio web y marcar la casilla de servicio FTP![[Instalación Servicios 20250709010152.png]]

Confirmamos la instalación y finalizamos, después revisamos la pestaña de Notificaciones y completamos las configuraciones necesarias.![[Instalación Servicios 20250709010220.png]]
...
Intervalo de direcciones IP:![[Instalación Servicios 20250709010337.png]]

Exclusión: (IP del servidor, para que DHCP no la asigne y no haya conflicto)
![[Instalación Servicios 20250709010359.png]]

Concesión:![[Instalación Servicios 20250709010427.png]]

Resolución de nombres![[Instalación Servicios 20250709010446.png]]

Activamos y finalizamos![[Instalación Servicios 20250709010459.png]]

Reserva cliente Linux

Para hacer la reserva debemos conocer la dirección MAC de nuestro cliente, para ello vamos a la información de red del cliente y nos fijamos en la dirección física.![[Instalación Servicios 20250709010512.png]]

Una vez conocemos la dirección MAC de nuestro cliente vamos al ámbito que creamos anteriormente, seleccionamos reservas y creamos una nueva reserva: asignamos un nombre e introducimos la dirección IP que queremos asignarle a la reserve y el protocolo compatible:![[Instalación Servicios 20250709010525.png]]

Comprobamos en el cliente:![[Instalación Servicios 20250709010536.png]]
...
![[Instalación Servicios 20250709010606.png]]
...
![[Instalación Servicios 20250709010657.png]]

Comprobamos en el cliente que la resolución de nombres funciona![[Instalación Servicios 20250709010713.png]]
![[Instalación Servicios 20250709010337.png]]

Accedemos al sitio web desde el navegador introduciendo el dominio![[Instalación Servicios 20250709010730.png]]

#### Creación usuarios:

Para crear usuarios vamos al panel de control -> Cambiar cuentas de usuario y agregamos usuarios.![[Instalación Servicios 20250709010752.png]]
...
![[Instalación Servicios 20250709010807.png]]

Hacemos que Olga y Lucia solo puedan ver sus carpeta y Miguel todas
![[Instalación Servicios 20250709010853.png]] 
![[Instalación Servicios 20250709010903.png]]

Agregamos el sitio FTP, para ello agregamos el host en DNS![[Instalación Servicios 20250709010916.png]]

Después añadimos el sitio FTP desde el administrador IIS![[Instalación Servicios 20250709010936.png]]
![[Instalación Servicios 20250709010944.png]]
...
![[Instalación Servicios 20250709011012.png]]



Ahora solo queda iniciar sesión en Thunderbird y comprobar que funciona

![[Instalación Servicios 20250709011038.png]]
![[Instalación Servicios 20250709011048.png]]
![[Instalación Servicios 20250709011118.png]]


Enviamos un mensaje desde la cuenta de Miguel y comprobamos que Olga lo recibe en el Buzón de su cuenta.
![[Instalación Servicios 20250709011132.png]]

Buzón de Olga![[Instalación Servicios 20250709011143.png]]
![[Instalación Servicios 20250709011150.png]]
