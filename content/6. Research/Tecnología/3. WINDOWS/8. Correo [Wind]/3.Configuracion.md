...
##### **Configuración:**
Después de instalar el servicio DNS procedemos a configurarlo, creamos una zona inversa, en la que especificaremos la dirección de red sobre la que estamos trabajando.
...
Además, deberemos introducir el host y dominio del intercambiador, en mi caso el host del intercambiador es el mismo que host normal y el dominio es la zona en la que está creado,
...
Nada más entrar nos saltara la notificación del correo, también podremos verla desde la bandeja de entrada de la cuenta.
