...
<img src="/media-content/Apuntes/media-informatica/Media Windows/Media FTP WIND/image2.gif" style="margin: 0 auto; padding: 0; width: 100%; height: auto;"
...
<img src="/media-content/Apuntes/media-informatica/Media Windows/Media FTP WIND/image1.png" style="margin: 0 auto; padding: 0; width: 100%; height: auto;" />
...
**Binario (por defecto):** **transmite bit a bit. Útil cuando no deben agruparse los bits porque el
fichero ya tiene una estructura propia (ficheros ejecutables, ISOs, imágenes, videos, audio, documentos, ficheros comprimidos...)**

**ASCII:** transmite byte a byte (caracteres). Es más rápido. Útil para ficheros de texto puro (txt, HTML...)

- Si se envía un archivo binario en modo ASCII, se corrompe la
