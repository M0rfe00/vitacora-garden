...
<!----------------Aqui acaba el codigo del filtro------------------->
        <article class="post programacion-post">
            ...
            <p class="parrafo-post">
                Donde y como descargar torrents de peliculas
            </p>
        </article>
        <article class="post otros-post">
            ...
            <p class="parrafo-post">
                Donde encontrar los subtitulos y como descargarlos
            </p>
        </article>
        <article class="post seguridad-post">
            ...
            <p class="parrafo-post">
                VLC en lo personal es la mejor opción, es compatible con prácticamente 
                todos los formatos de video, y te permite configurar los subtítulos y audios fácilmente
            </p>
        </article>
        <article class="post redes-post">
            ...
            <p class="parrafo-post">
                Hay algunas extensiones utiles si utilizas estas paginas, 
                como por ejemplo para evitar anuncios o descargar videos
            </p>
        </article>
  <!--   separación  -->
</div>
